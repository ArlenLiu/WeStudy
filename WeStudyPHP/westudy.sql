...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-02-24 03:54:09
-- 服务器版本： 5.7.10
-- PHP Version: 5.5.30
...
--
CREATE DATABASE IF NOT EXISTS `qdm157490578_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `qdm157490578_db`;
...
-- 表的结构 `WE_STUDY`
--
-- 创建时间： 2016-02-24 03:52:51
--

DROP TABLE IF EXISTS `WE_STUDY`;
CREATE TABLE IF NOT EXISTS `WE_STUDY` (
...
--
-- 插入之前先把表清空（truncate） `WE_STUDY`
--

TRUNCATE TABLE `WE_STUDY`;
/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
/*!40101 SET CHARACTER_SET_RESULTS=@OLD_CHARACTER_SET_RESULTS */;
/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;


INSERT INTO `WE_STUDY`(`id`, `username`, `userpwd`, `subject`, `tel`, `email`, `pid`, `studydata`, `studystatus`)
  VALUES (0,'admin','123','computer science','18370606387','arlenliugj@sina.cn','0000','iOS 学习','1');

INSERT INTO `WE_STUDY`(`id`, `username`, `userpwd`, `subject`, `tel`, `email`, `pid`, `studydata`, `studystatus`)
  VALUES (1,'arlen','12345','cs','18766209458','arlenliugj@gmail.com','1111','Android study','0');
